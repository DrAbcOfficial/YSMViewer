    ...
    private static MolangVariableItem CreateDefaultItem(string name)
    {
        ...
        return lower switch
        {
            _ when lower.Contains("is_") => new MolangVariableItem
            {
                ...
                IsBoolean = true, ControlType = MolangControlType.Toggle,
            },
            _ when lower.Contains("input_") => new MolangVariableItem
            {
                Name = name, DefaultValue = 0f, Value = 0f,
                MinValue = -1f, MaxValue = 1f, Step = 0.1f,
                ControlType = MolangControlType.Slider,
            },
            _ when lower.Contains("rotation") => new MolangVariableItem
            {
                Name = name, DefaultValue = 0f, Value = 0f,
                MinValue = -180f, MaxValue = 180f, Step = 1f,
                ControlType = MolangControlType.Slider,
            },
            _ when lower.Contains("health") => new MolangVariableItem
            {
                Name = name, DefaultValue = 20f, Value = 20f,
                MinValue = 0f, MaxValue = 20f, Step = 1f,
                ControlType = MolangControlType.Slider,
            },
            _ => new MolangVariableItem
            {
                Name = name, DefaultValue = 0f, Value = 0f,
                MinValue = 0f, MaxValue = 1f, Step = 0.1f,
                ControlType = MolangControlType.Slider,
            },
        };
    }
